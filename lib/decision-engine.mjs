...
export function evaluateDecision(input = {}) {
  ...
  return {
    ...
    reasons: buildReasons({ choice, action, gap, trendScore, momentumScore, confidence, stability, flipRisk, marketValue, timeSweetSpot, indicatorAgreement, micro, windowContext, underGate })
  };
}
...
function buildReasons({ choice, action, gap, trendScore, momentumScore, confidence, stability, flipRisk, marketValue, timeSweetSpot, indicatorAgreement, micro = {}, windowContext = {}, underGate = null }) {
  const reasons = [];
