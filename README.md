# Edge15 Under Balance 13

BTC 15-minute prediction-market decision assistant.

## Version file

`edge15-under-balance-13.zip`
...
- Live odds cache added.
- Uses latest fresh Coinbase Yes/No odds at official tracker lock.
- Shows odds cache status and odds age.
- Assumes $0.50 stake.
- Calculates estimated return, net profit/loss, and ROI from cached live odds.
- If Coinbase odds are stale or missing, returns are marked unavailable and are not guessed.
