...
const APP_VERSION_FILE = 'edge15-genesis-pro-trader-stack-33-analyst-bot-clone.zip';
const LEARNING_SAMPLE_TARGET = 25;
const STORE_KEY = 'edge15.clone.protrader33.records.v1';
const SETTINGS_KEY = 'edge15.clone.protrader33.settings.v1';
const LADDERS_KEY = 'edge15.clone.protrader33.ladders.v1';
const CURRENT_LADDER_KEY = 'edge15.clone.protrader33.currentLadder.v1';
const ODDS_CACHE_KEY = 'edge15.clone.protrader33.oddsCache.v1';
const MAX_TICKS = 900;
