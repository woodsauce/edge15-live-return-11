...
const APP_VERSION_FILE = 'edge15-genesis-balanced-28-replay-gated.zip';
...
function getOfficialLockCandidate(decision, remainingSec) {
  ...
  if (earlyGenesisLock) {
    return {
      allow: false,
      reason: '8m Genesis early lock is preview-only in V28; official money entry starts at 6m/4m balanced confirmation.',
      minute,
      entryQuality,
      heldMs,
      valueSnapshot,
